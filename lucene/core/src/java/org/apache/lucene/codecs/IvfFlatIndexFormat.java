...
public abstract class IvfFlatIndexFormat {
  ...
  public static final IvfFlatIndexFormat EMPTY = new IvfFlatIndexFormat() {
    ...
    /**
     * Returns a {@link IvfFlatIndexWriter} to write the vectors and IVF to the index.
     */
    @Override
    ...
    /**
     * Returns a {@link IvfFlatIndexReader} to read the vectors and IVF from the index.
     */
    @Override
