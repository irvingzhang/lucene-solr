...
public class Lucene90IvfFlatIndexFormat extends IvfFlatIndexFormat {
  ...
  static final String IVF_DATA_CODEC_NAME = "Lucene90IvfFlatIndexFormatData";

  static final String VECTOR_DATA_CODEC_NAME = "Lucene90VectorFormatData";

  static final String META_EXTENSION = "ifi";

  static final String IVF_DATA_EXTENSION = "ifd";
   ...
   */
  Lucene90IvfFlatIndexFormat(Mode mode) {
    this.mode = mode;
  }

  @Override
  public IvfFlatIndexWriter fieldsWriter(SegmentWriteState state) throws IOException {
    return this.mode == Mode.BEST_SPEED ? new Lucene90IvfFlatIndexWriter(state) :
        new Lucene90IvfFlatIndexWriterV2(state);
  }
  ...
  public IvfFlatIndexReader fieldsReader(SegmentReadState state) throws IOException {
    return this.mode == Mode.BEST_SPEED ? new Lucene90IvfFlatIndexReader(state) :
        new Lucene90IvfFlatIndexReaderV2(state);
  }
}
