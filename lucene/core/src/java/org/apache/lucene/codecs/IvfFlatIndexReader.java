...
public abstract class IvfFlatIndexReader implements Closeable, Accountable {
  /** Sole constructor */
  protected IvfFlatIndexReader() {}
  ...
  public abstract IvfFlatValues getIvfFlatValues(final String field) throws IOException;
  ...
  public IvfFlatIndexReader getMergeInstance() {
    return this;
  }
}
